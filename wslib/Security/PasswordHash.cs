...
namespace wslib.Security
{
    ...
    public struct PasswordHash
    {
        ...
        public static bool operator ==(PasswordHash left, PasswordHash right) => (left.Hash == right.Hash) && (left.Iterations == right.Iterations) && (left.Salt == right.Salt);
        /// <summary>
        /// Compares two PasswordHash objects for equality.
        /// </summary>
        /// <param name="left">wslib.Security.PasswordHash one</param>
        ...
        {
            string saltSize = this.Salt.Length switch
            {
